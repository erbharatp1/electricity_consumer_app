...
import com.naged.onboarding.domain.ElectricityReading;
import com.naged.onboarding.domain.PricePlan;
...
public class PricePlanService {
 // use @auth wired annotation to inject the dependencies
    @Autowired
    private final List<PricePlan> pricePlans;
    @Autowired  private final MeterReadingService meterReadingService;
   // remove the constructor and create a setter method for the dependencies
    ...
    private BigDecimal calculateAverageReading(List<ElectricityReading> electricityReadings) {
        BigDecimal summedReadings = electricityReadings.stream()
                ...
                // need to replace with method reference  BigDecimal::add
